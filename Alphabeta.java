...
public class Alphabeta implements Cloneable{
		...
		public Alphabeta(int player, int depth, int[] p2State, int[] p1State, int p2Mancala, int p1Mancala, int value, String name, int index, int alpha, int beta) {
            super();
            this.player = player;
            this.depth = depth;
        ...
        public Alphabeta(int task, int player,int depth, int cutOffDepth, int[] p2State, int[] p1State, int p2Mancala, int p1Mancala, int alpha, int beta) {
            super();
            this.task = task;
            this.player = player;
            this.depth = depth;
		...
		public String toString() {
			return "Alphabeta [player=" + player + ", depth=" + depth
        ...
        public void alphaBeta() throws CloneNotSupportedException, FileNotFoundException {
            ...
            while(checkIfEndedInMancala == 1){
            	this.setAlpha(Integer.MIN_VALUE);
            	this.setBeta(Integer.MAX_VALUE);
                maxValue(this);
        ...
        public int maxValue(Alphabeta currentState) throws CloneNotSupportedException {
            if(currentState.getDepth() == globalDepth ){
             ...
             if(currentState.getPlayer() == 1){
                ...
                for(int j=0;j < currentState.p1State.length;j++){
                    ...
                    Alphabeta newObj=new Alphabeta(2, (currentState.getDepth()+1), p2Arr, p1Arr, currentState.p2Mancala, currentState.p1Mancala, currentState.getValue(), "B", (j+2), currentState.getAlpha(), currentState.getBeta());
                    ...
                    if(newObj.isEndGame()){
                    	if(checkIfEndedInMancala == 1){
                    		System.out.println(newObj.getName()+newObj.getIndex()+","+newObj.getDepth()+","+"-Infinity"+","+getValue(newObj.getAlpha())+","+getValue(newObj.getBeta()));
                    		System.out.println(newObj.getName()+newObj.getIndex()+","+newObj.getDepth()+","+getEval(newObj)+","+getValue(newObj.getAlpha())+","+getValue(newObj.getBeta()));
                    	}
                    	else{
                    ...
                    if(currentState.getValue() >= currentState.getBeta()){
                    	printTraverseLog(currentState);
                    	return currentState.getValue();
                    }
                    
                    currentState.setAlpha(currentState.getAlpha() > currentState.getValue() ? currentState.getAlpha():currentState.getValue());
                    printTraverseLog(currentState);
                }
                return currentState.getValue();
            }
                ...
                for(int j=0;j < currentState.getP2State().length;j++){
                    ...
                    Alphabeta newObj=new Alphabeta(1, (currentState.getDepth()+1), p2Arr, p1Arr, currentState.p2Mancala, currentState.p1Mancala, currentState.getValue(), "A", (j+2), currentState.getAlpha(), currentState.getBeta());
        ...
        public int minValue(Alphabeta currentState) throws CloneNotSupportedException {
            ...
            if(currentState.getPlayer() == 1){
                ...
                for(int j=0;j < currentState.getP1State().length;j++){
                    ...
                    if(currentState.getValue() <= currentState.getAlpha()){
                    	printTraverseLog(currentState);
                    	return currentState.getValue();
                    }
                    
                    currentState.setBeta(currentState.getBeta() < currentState.getValue() ? currentState.getBeta():currentState.getValue());
        ...
        public int eval(){
            ...
            if(globalPlayer == 1){
            	if(this.getCheckIfExtraChance() == 0){
            		System.out.println(this.getName()+this.getIndex()+","+this.getDepth()+","+(this.p1Mancala-this.p2Mancala)+","+getValue(this.getAlpha())+","+getValue(this.getBeta()));
            		return this.p1Mancala-this.p2Mancala;
            	}
            }
            else{
            	if(this.getCheckIfExtraChance() == 0){
            		System.out.println(this.getName()+this.getIndex()+","+this.getDepth()+","+(this.p2Mancala-this.p1Mancala)+","+getValue(this.getAlpha())+","+getValue(this.getBeta()));
        ...
        public int playMancala(Alphabeta currentObj,int pit, int player){
        ...
        public void printTraverseLog(Alphabeta currentState){
        	if(currentState.getDepth() > 0){
            	if(currentState.getCheckIfExtraChance() == 1){
            		System.out.println(currentState.getName()+currentState.getIndex()+","+(currentState.getDepth()+1)+","+getValue(currentState.getValue())+","+getValue(currentState.getAlpha())+","+getValue(currentState.getBeta()));
            	}
            	else
            		System.out.println(currentState.getName()+currentState.getIndex()+","+currentState.getDepth()+","+getValue(currentState.getValue())+","+getValue(currentState.getAlpha())+","+getValue(currentState.getBeta()));
            }
            else{
            	if(currentState.getCheckIfExtraChance() == 1){
            		System.out.println(currentState.getName()+currentState.getIndex()+","+(currentState.getDepth()+1)+","+getValue(currentState.getValue())+","+getValue(currentState.getAlpha())+","+getValue(currentState.getBeta()));
            		...
            		System.out.println("root"+","+currentState.getDepth()+","+getValue(currentState.getValue())+","+getValue(currentState.getAlpha())+","+getValue(currentState.getBeta()));
            }
        }
        ...
        public int getEval(Alphabeta obj){
